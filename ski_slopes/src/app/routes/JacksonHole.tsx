...
const JacksonHole = () => {
  ...
  const imagePath = "/assets/cardsinfo/jacksonhole-map.avif";
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-12">
      ...
      <div className="relative h-64 md:h-80 lg:h-96 overflow-hidden bg-blue-900">
        <div 
          className="absolute inset-0 bg-cover bg-center"
          style={{ 
            backgroundImage: 'url(/assets/jackson_hole/jackson_hole.png)', 
        ...
        <div className="relative h-full flex items-end z-10">
          <div className="container mx-auto px-4 py-8">
            ...
            <p className="text-lg text-blue-100 mt-2 max-w-3xl">
              Renowned for its steep terrain, deep powder, and breathtaking alpine scenery
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 p-6 md:p-8">
            ...
            <div className="lg:col-span-3 order-2 lg:order-1">
              {isLoading ? (
                ...
                <div className="relative rounded-lg overflow-hidden shadow-md transform transition-transform hover:scale-[1.01] duration-300">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                    <p className="text-white text-sm">Trail map of Jackson Hole Mountain Resort</p>
                  </div>
                </div>
              )}
              ...
              <div className="mt-8 bg-blue-50 p-6 rounded-lg border border-blue-100">
                <h2 className="text-2xl font-bold text-blue-900 mb-4">About the Resort</h2>
                ...
                <p className="text-gray-700 leading-relaxed">
                  The resort is famous for its iconic aerial tram and challenging terrain, including the legendary Corbet's Couloir - one of the most famous ski runs in North America. With 2,500 acres of terrain and extensive backcountry access, it offers unparalleled adventure for skiers and snowboarders.
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 order-1 lg:order-2">
              <div className="bg-blue-900 rounded-lg p-6 text-white">
                ...
                <ul className="space-y-3 text-blue-100">
                  <li className="flex justify-between border-b border-blue-800 pb-2">
                    ...
                    <span>Teton Village, Wyoming</span>
                  </li>
                  <li className="flex justify-between border-b border-blue-800 pb-2">
                  ...
                  <li className="flex justify-between border-b border-blue-800 pb-2">
                    ...
                    <span className="font-bold text-white">4,139 ft</span>
                  </li>
                  <li className="flex justify-between border-b border-blue-800 pb-2">
                  ...
                  <li className="flex justify-between border-b border-blue-800 pb-2">
                    ...
                    <span>459 inches</span>
                  </li>
                  <li className="flex justify-between">
                    <span className="font-medium">Lift System:</span>
                    <span className="text-right">13 lifts (1 tram, 2 gondolas, 10 chairs)</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="mt-6 bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg p-6 text-white shadow-lg">
                ...
                <p className="text-blue-100 mb-4 text-center">Ready to experience Jackson Hole's legendary terrain?</p>
                <div className="flex justify-center">
                  <a href="https://www.jacksonhole.com" target="_blank" rel="noopener noreferrer" className="inline-block bg-white text-blue-700 px-5 py-2 rounded-md font-medium hover:bg-blue-50 transition-colors">
                    Official Website
                  </a>
                </div>
              </div>
