...
const Snowbird = () => {
  ...
  const imagePath = "/assets/cardsinfo/snowbird-map.jpg";
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-12">
      ...
      <div className="relative h-64 md:h-80 lg:h-96 overflow-hidden bg-indigo-900">
        <div 
          className="absolute inset-0 bg-cover bg-center"
          style={{ 
            backgroundImage: 'url(/assets/snowbird/snowbird.png)', 
        ...
        <div className="relative h-full flex items-end z-10">
          <div className="container mx-auto px-4 py-8">
            ...
            <p className="text-lg text-indigo-100 mt-2 max-w-3xl">
              Utah's legendary powder paradise in Little Cottonwood Canyon
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 p-6 md:p-8">
            ...
            <div className="lg:col-span-3 order-2 lg:order-1">
              {isLoading ? (
                ...
                <div className="relative rounded-lg overflow-hidden shadow-md transform transition-transform hover:scale-[1.01] duration-300">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                    <p className="text-white text-sm">Trail map of Snowbird Ski & Summer Resort</p>
                  </div>
                </div>
              )}
              ...
              <div className="mt-8 bg-indigo-50 p-6 rounded-lg border border-indigo-100">
                <h2 className="text-2xl font-bold text-indigo-900 mb-4">About the Resort</h2>
                ...
                <p className="text-gray-700 leading-relaxed">
                  The resort is famous for its aerial tram, which provides access to Hidden Peak at 11,000 feet and spectacular views of the Wasatch Mountains. Snowbird's varied terrain offers everything from gentle slopes to some of the steepest and most challenging runs in North America, all covered in Utah's famous light, dry powder.
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 order-1 lg:order-2">
              <div className="bg-indigo-900 rounded-lg p-6 text-white">
                ...
                <ul className="space-y-3 text-indigo-100">
                  <li className="flex justify-between border-b border-indigo-800 pb-2">
                    ...
                    <span>Little Cottonwood Canyon, Utah</span>
                  </li>
                  <li className="flex justify-between border-b border-indigo-800 pb-2">
                  ...
                  <li className="flex justify-between border-b border-indigo-800 pb-2">
                    ...
                    <span className="font-bold text-white">3,240 ft</span>
                  </li>
                  <li className="flex justify-between border-b border-indigo-800 pb-2">
                  ...
                  <li className="flex justify-between border-b border-indigo-800 pb-2">
                    ...
                    <span className="font-bold text-white">500 inches</span>
                  </li>
                  <li className="flex justify-between border-b border-indigo-800 pb-2">
                    <span className="font-medium">Longest Run:</span>
                    <span>2.5 miles (Chip's Run)</span>
                  </li>
                  <li className="flex justify-between">
                    <span className="font-medium">Lift System:</span>
                    <span className="text-right">14 lifts</span>
                  </li>
                </ul>
              </div>
                ...
                <div className="space-y-3">
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm font-medium text-gray-800">27%</span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-sm font-medium text-gray-800">38%</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
              ...
              {/* Call to action */}
              <div className="mt-6 bg-gradient-to-r from-indigo-600 to-indigo-800 rounded-lg p-6 text-white shadow-lg">
                <h3 className="text-xl font-bold mb-2 text-center">Plan Your Visit</h3>
                <p className="text-indigo-100 mb-4 text-center">Experience Utah's legendary powder at Snowbird!</p>
                <div className="flex justify-center">
                  <a href="https://www.snowbird.com" target="_blank" rel="noopener noreferrer" className="inline-block bg-white text-indigo-700 px-5 py-2 rounded-md font-medium hover:bg-indigo-50 transition-colors">
                    Official Website
                  </a>
                </div>
              </div>
